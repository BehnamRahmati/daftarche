...
function SidebarMenu() {
	...
	return (
		<div
			className={`px-3 flex flex-col relative py-5 w-full overflow-hidden transition-[width] duration-400 bg-white dark:bg-[var(--foreground)] h-full rounded-3xl lg:border lg:border-zinc-200 lg:dark:border-[var(--secondary-heavy)] ${
				closeSidebar ? 'lg:w-18' :  'lg:w-2xs'
			}`}>
